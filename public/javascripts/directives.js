app.factory('crudService', function ($http, $q) {
        ...
        return {
            ...
            controller: function ($scope, $timeout, $stateParams ) {
                ...
                if($scope.collectionName == null)
                    $scope.collectionName = $stateParams.collection.substring(0, $stateParams.collection.length-1);
